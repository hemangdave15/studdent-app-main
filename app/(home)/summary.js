              ...
              >
                <DataTable>
                  <DataTable.Header>
                    ...
                    <DataTable.Title>EC</DataTable.Title>
                    <DataTable.Title>MD</DataTable.Title>
                  </DataTable.Header>
                  <DataTable.Row>
                    <DataTable.Cell>{item?.present}</DataTable.Cell>
                    <DataTable.Cell>{item?.absent}</DataTable.Cell>
                    <DataTable.Cell>{item?.extra_curricular}</DataTable.Cell>
                    <DataTable.Cell>{item?.medical_leave}</DataTable.Cell>
                  </DataTable.Row>
                </DataTable>
              </View>
            </View>
